...
function FavoritePage() {
    ...
    useEffect(() => {
        console.log("useEffect function used")
        fetchFavoredMovie()
    }, [])

    const fetchFavoredMovie = () => {
        console.log('fetchFavoredFunction used')
    ...
    const renderCards = Favorites.map((favorite, index) => {
        ...
        return <tr key={index}>
            ...
            <td><button onClick={() => onClickDelete(favorite.movieId, favorite.userFrom)}> Remove movie </button></td>
            </tr>
    })
